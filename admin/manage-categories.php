...
<?php if (isset($_SESSION['add-category-success'])) : ?>
    <!-- show if add category was succesfull -->
        ...
        <?php elseif (isset($_SESSION['add-category'])) : ?>
             <!-- show if add category was not succesfull -->
        ...
        <?php elseif (isset($_SESSION['edit-category-success'])) : ?>
             <!-- show if edit category was succesfull -->
        <div class="alert__message success container">
            <p>
        ...
        <?php elseif (isset($_SESSION['edit-category'])) : ?>
             <!-- show if edit category was not succesfull -->
        <div class="alert__message error container">
            <p>
        ...
        <?php elseif (isset($_SESSION['delete-category-success'])) : ?>
             <!-- show if delete category was succesfull -->
        <div class="alert__message success container">
            <p>
